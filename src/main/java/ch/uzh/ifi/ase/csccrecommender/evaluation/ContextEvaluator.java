...
public class ContextEvaluator {
  ...
  public void trainAndEvaluateOnContextDataset(int numOfCrossValidations, String tempEvaluationResultsDirectoryPath) {
    methodInvocationIndex.clearIndex();
    List<String[]> groups = splitContextDataset(numOfCrossValidations);
    ...
    for (int j = 0; j < numOfCrossValidations; j++) {
